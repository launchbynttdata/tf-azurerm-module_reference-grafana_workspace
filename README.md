...
| <a name="module_grafana"></a> [grafana](#module\_grafana) | terraform.registry.launch.nttdata.com/module_primitive/grafana/azurerm | ~> 2.0 |
...
| <a name="input_monitor_workspace_name"></a> [monitor\_workspace\_name](#input\_monitor\_workspace\_name) | Name of the Azure Monitor workspace. If null, a name is generated by the naming module. | `string` | `null` | no |
